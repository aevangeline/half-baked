...
pub struct ToDo {
    ...
    pub goal_time: Option<chrono::NaiveDateTime>, // when we want to get this todo item done by
...
pub struct Event {
    ...
    pub name: String, // what the name of this event
    pub start_time: chrono::NaiveDateTime, // when the event actually starts
    pub end_time: chrono::NaiveDateTime, // when the event ends
